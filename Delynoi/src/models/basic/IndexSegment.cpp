...
IndexSegment::IndexSegment(const IndexSegment &other) : Segment(other) {
    this->p1 = other.p1;
    this->p2 = other.p2;
...
bool IndexSegment::contains(const std::vector<Point> &p, const IndexSegment &s) {
...
bool IndexSegment::intersection(const std::vector<Point> &points, const PointSegment &other, Point &inter) {
    return Segment::intersects(points[this->p1], points[this->p2], other.getFirst(), other.getSecond(), inter);
}

bool IndexSegment::intersection(const std::vector<Point> &points, const IndexSegment &other, Point &inter) {
